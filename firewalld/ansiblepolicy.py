...
with open('/media/sf_shared-folder/ansible/firewalld/policies.csv', newline='') as csvfile:
...
with open('/media/sf_shared-folder/ansible/firewalld/configure-firewalld.yml', 'r') as stream:
    try:
